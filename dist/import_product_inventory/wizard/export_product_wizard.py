...
class export_product_with_inventory_file(models.TransientModel):
    ...
    _description ='export.product.with.inventory.file'
...
#         })
        ...
        headers = ['id','create_date','Archive','invoice_policy','purchase_method','l10n_mx_edi_code_sat_id', 'categ_id/name','pos_categ_id/name','available_in_pos','name','barcode','default_code','unit_of_measurement','uom_po_id','supplier_taxes_id','taxes_id','type','route_ids/id','purchase_ok','sale_ok','standard_price','lst_price','seller_ids/name/name','image_medium']
        warehouse_ids = []
